...
check(table.getn(V.armorSlotPanels)==4 and V.armorDecorationFrame.width==327 and V.armorDecorationFrame.height==357,"Four decoration panels use the adjusted Outfit trim width")
...
check(V.model:IsVisible() and V.pagesByName.armor:IsVisible() and not V.armorDecorationFrame:IsVisible() and not V.armorShadowFrame:IsVisible(),"Race view keeps the live wardrobe model visible without armor decorations")
...
V:SetTab("armor")
check(not DropDownList1:IsShown() and V.armorDecorationFrame:IsVisible() and V.armorShadowFrame:IsVisible() and not V.pagesByName.body:IsVisible(),"Returning to Outfit restores decorations and dismisses body controls")
V:SetTab("body")
